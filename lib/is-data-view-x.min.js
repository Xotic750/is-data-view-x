 ...
 */
"use strict";var legacyCheck,attempt=_dereq_("attempt-x"),isObjectLike=_dereq_("is-object-like-x"),hasDView="function"==typeof DataView,getByteLength=!1;if(hasDView){var res=attempt(function(){return new DataView(new ArrayBuffer(4))}),dataView=!1===res.threw&&isObjectLike(res.value)&&res.value;if(dataView&&_dereq_("has-to-string-tag-x")){var descriptor=_dereq_("object-get-own-property-descriptor-x")(DataView.prototype,"byteLength");descriptor&&"function"==typeof descriptor.get&&(res=attempt.call(dataView,descriptor.get),getByteLength=!1===res.threw&&"number"==typeof res.value&&descriptor.get)}if(!1===getByteLength){var toStringTag=_dereq_("to-string-tag-x");if("[object DataView]"===toStringTag(dataView))legacyCheck=function _legacyCheck(object){return"[object DataView]"===toStringTag(object)};else{var isArrayBuffer=_dereq_("is-array-buffer-x");legacyCheck=function _legacyCheck(object){var isByteLength="number"==typeof object.byteLength,isByteOffset="number"==typeof object.byteOffset,isGetFloat32="function"==typeof object.getFloat32,isSetFloat64="function"==typeof object.setFloat64;return isByteLength&&isByteOffset&&isGetFloat32&&isSetFloat64&&isArrayBuffer(object.buffer)}}}}module.exports=function isDataView(object){if(!1===hasDView||!1===isObjectLike(object))return!1;if(legacyCheck)return legacyCheck(object);var result=attempt.call(object,getByteLength);return!1===result.threw&&"number"==typeof result.value}},{"attempt-x":3,"has-to-string-tag-x":7,"is-array-buffer-x":8,"is-object-like-x":16,"object-get-own-property-descriptor-x":25,"to-string-tag-x":37}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":34,"to-property-key-x":36}],6:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toStringTag,aBufTag,attempt=_dereq_("attempt-x"),isObjectLike=_dereq_("is-object-like-x"),hasABuf="function"==typeof ArrayBuffer,bLength=!1;if(hasABuf){if(_dereq_("has-to-string-tag-x")){var descriptor=_dereq_("object-get-own-property-descriptor-x")(ArrayBuffer.prototype,"byteLength");if(descriptor&&"function"==typeof descriptor.get){var res=attempt(function(){return new ArrayBuffer(4)});!1===res.threw&&isObjectLike(res.value)&&(res=attempt.call(res.value,descriptor.get),bLength=!1===res.threw&&"number"==typeof res.value&&descriptor.get)}}!1===bLength&&(toStringTag=_dereq_("to-string-tag-x"),aBufTag="[object ArrayBuffer]")}module.exports=function isArrayBuffer(object){if(!1===hasABuf||!1===isObjectLike(object))return!1;if(!1===bLength)return toStringTag(object)===aBufTag;var result=attempt.call(object,bLength);return!1===result.threw&&"number"==typeof result.value}},{"attempt-x":3,"has-to-string-tag-x":7,"is-object-like-x":16,"object-get-own-property-descriptor-x":25,"to-string-tag-x":37}],9:[function(_dereq_,module,exports){"use strict";var getDay=Date.prototype.getDay,tryDateObject=function tryDateObject(value){try{return getDay.call(value),!0}catch(e){return!1}},toStr=Object.prototype.toString,hasToStringTag="function"==typeof Symbol&&"symbol"==typeof Symbol.toStringTag;module.exports=function isDateObject(value){return"object"==typeof value&&null!==value&&(hasToStringTag?tryDateObject(value):"[object Date]"===toStr.call(value))}},{}],10:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":14}],12:[function(_dereq_,module,exports){/**
 ...
 * @module is-nan-x
 */
"use strict";module.exports=function isNaN(value){return value!==value}},{}],15:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":20,"validate.io-undefined":42}],16:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":14,"to-number-x":33}],23:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],24:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":41,"white-space-x":43}],25:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":18}],28:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":15}],29:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":23,"to-integer-x":31}],33:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":28}],35:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":6,"to-primitive-x":35,"to-string-x":38}],37:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":20,"validate.io-undefined":42}],38:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":19}],39:[function(_dereq_,module,exports){/**
